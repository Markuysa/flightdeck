---
name: ponytail
description: Minimal-code discipline for writing, refactoring, and fixing code — climb the ladder from "does this need to exist" to "minimum that works" before adding anything.
license: MIT
---

<!--
  Vendored from https://github.com/DietrichGebert/ponytail (MIT, © Dietrich Gebert).
